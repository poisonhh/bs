  ...
  <tbody>
    ...
    <tr>
      <td height="23" align="center" class="td_bg"><p>&nbsp;</p>
	     <form action="caradd_admin" method="post"  onsubmit="return checkmadd();">
        ...
        <tr>
          ...
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="color" id="color" class="inputcss" />
          </label></td>
        </tr>
         <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">品牌：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="brand" id="brand" class="inputcss" />
          </label></td>
        </tr>
        <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">类型：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="model" id="model" class="inputcss" />
          </label></td>
        </tr>
        <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">车牌号：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="carnumber" id="carnumber" class="inputcss" />
          </label></td>
        </tr>
       <!--  <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">购入时间：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="buytime" id="buytime" class="inputcss" />
          </label></td>
        </tr> -->
        <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">描述：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="cardetail" id="cardetail" class="inputcss" />
          </label></td>
        </tr>
