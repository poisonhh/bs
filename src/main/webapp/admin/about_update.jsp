...
border="0">
  <tbody>
    <tr>
      <th class="bg_tr" align="left" height="25">栏目修改</th>
    </tr>
    <tr>
      <td height="23" align="center" class="td_bg"><p>&nbsp;</p>
	     <form action="${pageContext.request.contextPath }/admin/abouttoupdate_admin/${about.id}" method="post"  onsubmit="return checkmadd();">
        ...
        <tr>
          ...
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="title" id="title" value="${about.title}"  class="inputcss" />
          </label></td>
        </tr>
         ...
         <tr>
          ...
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            ...
            <textarea name="content" id="content" rows="50" cols="70" style="height:250px;">${about.content }</textarea>
          </label></td>
        </tr>
        <tr>
          ...
          <td bgcolor="#FFFFFF"><label>
            <input type="submit" name="Submit" value="提交" />
              <input name="about.id" value="${about.id }" id="id"  type="hidden" size="20"  maxlength="20" />
          </label></td>
        </tr>
      </table> 
	      </form>	
