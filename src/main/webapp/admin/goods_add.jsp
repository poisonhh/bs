    ...
    <tr>
      ...
      <tr>
          ...
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
 			<input type="text" name="cid" id="cid" class="inputcss" />						
          </label></td>
        </tr>
        <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">名称：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="name" id="name" class="inputcss" />
          </label></td>
        </tr>
        <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">价格：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="price" id="price" class="inputcss" />
          </label></td>
        </tr>        
          <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">数量：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="num" id="num" class="inputcss" />
          </label></td>
        </tr>         
           <tr>
          <td width="133" height="40" align="right" bgcolor="#FFFFFF">图片：</td>
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
           <!--  <file name="picurl" id="file" theme="simple"></file> -->
