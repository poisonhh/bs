      ...
      <td height="23" align="center" class="td_bg"><p>&nbsp;</p>
        ...
        <tr>
          ...
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="amdin.username" id="name"  value="${username}" class="inputcss" />
          </label></td>
        </tr>
        <tr>
          <td height="40" align="right" bgcolor="#FFFFFF">密码：</td>
          <td align="left" bgcolor="#FFFFFF"><input type="text" name="admin.password"  value="${password}" id="pass" class="inputcss" /></td>
        </tr>
        <tr>
          <td height="40" align="right" bgcolor="#FFFFFF">&nbsp;</td>
          <td bgcolor="#FFFFFF"><label>
           <input name="admin.id" value="${id }" id="id"  type="hidden" size="20"  maxlength="20" />
