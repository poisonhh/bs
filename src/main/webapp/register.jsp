			    ...
			    <table width="491" border="0" align="center">
                  ...
                  <tr>
                    <td width="108" height="33" align="right">&nbsp;&nbsp;账号：&nbsp;
                      <label></label></td>
                    <td width="373">&nbsp;<input name="username" id="username" type="text" size="30" maxlength="20"/></td>
                  </tr>
                  <tr>
                    <td height="34" align="right">密码：</td>
                    <td height="34">&nbsp;<input name="password" id="u_pwds"  type="password" size="33" maxlength="20"/></td>
                  </tr>
				   <tr>
                  ...
                  <tr>
                   ...
                   <!--  <td height="34">&nbsp;<input name="sex" id="u_sex"  type="text" size="33" maxlength="20"/></td> -->
                    <td width="75%">
						       <select name="sex">
                  ...
                  <tr>
                    ...
                    <td height="34">&nbsp;<input name=telnumber id="u_phone"  type="text" size="33" maxlength="20"/></td>
                  </tr>
                  <tr>
                    <td height="34" align="right">邮箱：</td>
                    <td height="34">&nbsp;<input name="email" id="u_email"  type="text" size="33" maxlength="20"/></td>
                  </tr>
                  <tr>
                    <td height="34" align="right">QQ：</td>
                    <td height="34">&nbsp;<input name="qq" id="u_qq"  type="text" size="33" maxlength="20"/></td>
                  </tr>
                  <tr>
                    <td height="34" align="right">身份证：</td>
                    <td height="34">&nbsp;<input name="idcard" id="u_idcard"  type="text" size="33" maxlength="20"/></td>
                  </tr>
                  <tr>
                    <td height="34" align="right">驾驶证：</td>
                    <td height="34">&nbsp;<input name="licensenumber" id="u_licensenumber"  type="text" size="33" maxlength="20"/></td>
                  </tr>
