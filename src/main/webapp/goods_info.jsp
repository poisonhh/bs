      ...
      <tr>
        <td height="455" valign="top" class="content">
			    ...
			    <table width="600" border="0" align="center">
                  <tr>
                    <td width="305" rowspan="6"><img  src="${goods.picurl }"  width="284" height="261" class="img" /></td>
                    <td width="285" height="35">&nbsp;<a href="<%=request.getContextPath() %>/cartadd_admin/${goods.gid }"><img src="images/order.jpg"  border="0"/></a></td>
                  </tr>
                  <tr>
                    <td height="33">价格：${goods.price }元/天</td>
                  </tr>
                  <tr>
                    <td height="34">名称：${goods.name}</td>
                  </tr>
                    <tr>
                    <td height="31">数量：${goods.num }</td>
                  </tr>
                  <tr>
                    <td height="201" valign="top">${goods.content }</td>
                  </tr>
                </table>
