            ...
            <table width="252" border="0" cellpadding="0" cellspacing="1" bgcolor="#BCE118">
              <tr>
                ...
                <td width="169" bgcolor="#FFFFFF"><label> &nbsp;
                     <input type="text" name="lvo.username" id="u_name" class="input" />
                </label></td>
              </tr>
              <tr>
                <td height="30" align="right" bgcolor="#FFFFFF">密码：</td>
                <td bgcolor="#FFFFFF">&nbsp;
                   <input type="password" name="lvo.password" id="u_pwd" class="input" />
                </td>
              </tr>
              <tr>
       ...
       <%}else{%>
              <table width="252" border="0" cellpadding="0" cellspacing="1" bgcolor="#BCE118">
                <tr>
                  ...
                  欢迎用户${USERS.username }登陆<br />
                <br />
               <a href="<%=request.getContextPath() %>/orders_list"><span>我的订单</span></a> <br />
                <br />
                 <a href="<%=request.getContextPath() %>/cart_list"><span>购物车</span></a>&nbsp;<a href="<%=request.getContextPath() %>/exit.jsp"><span>退出</span></a>
                <br />
                    <br />
                <br />
                <br />
