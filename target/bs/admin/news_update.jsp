  ...
  <tbody>
    ...
    <tr>
      <td height="23" align="center" class="td_bg"><p>&nbsp;</p>
	     <form action="${pageContext.request.contextPath }/admin/newsupdate_admin/${news.id}" method="post"  onsubmit="return checkmadd();">
        ...
        <tr>
          ...
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            <input type="text" name="title" id="title" value="${news.title}"  class="inputcss" />
          </label></td>
        </tr>
         ...
         <tr>
          ...
          <td width="460" align="left" bgcolor="#FFFFFF"><label>
            ...
            <textarea name="content" id="content" rows="50" cols="70" style="height:250px;">${news.content}</textarea>
          </label></td>
        </tr>
        <tr>
          ...
          <td bgcolor="#FFFFFF"><label>
            <input type="submit" name="Submit" value="提交" />
              <input name="news.id" value="${news.id}" id="id"  type="hidden" size="20"  maxlength="20" />
          </label></td>
        </tr>
      </table> 
	      </form>	
