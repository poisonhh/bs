...
border="0">
  <tbody>
    <tr>
      <th class="bg_tr" align="left" height="25">管理员管理列表</th>
    </tr>
    <tr>
      ...
      <table width="98%" border="0" cellpadding="1" cellspacing="1" bgcolor="#3498DA" >
        <tr>
          ...
          <td width="216" align="center" bgcolor="#FFFFFF">用户名</td>
          <td width="146" align="center" bgcolor="#FFFFFF">密码</td>
        ...
        <tr>
          ...
          <a href="<%=request.getContextPath() %>/admindelete_admin?mvo.id=${obj.id }" onClick="return confirm('确定删除吗？')">删除</a>&nbsp;&nbsp;<a href="admintoupdate_admin?mvo.id=${obj.id }">修改</a>
          </td>
        </tr>
		</c:forEach>
      </table>      
