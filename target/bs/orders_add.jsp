...
<table width="1004" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="726" valign="top"><table width="700" border="0" align="center" cellpadding="0" cellspacing="0"  class="right_box">
      <tr>
        <td height="39" align="center" class="subject">填写订单邮件信息</td>
      </tr>
      <tr>
        <td height="455" valign="top" class="content">

			
	  <form action="/ordersadd_admin" method="post"  onsubmit="return checkreg();">
			    <table width="491" border="0" align="center">
              
                  <tr>
                    <td width="108" height="33" align="right">&nbsp;&nbsp;联系人：&nbsp;
                      <label></label></td>
                    <td width="373">&nbsp;<input name="mvo.name" id="name" type="text" size="30" maxlength="20"/></td>
                  </tr>
         
                  <tr>
                    <td height="34" align="right">用车时间：</td>
                    <td height="34">&nbsp;<input name="mvo.postcode" id="postcode"  type="text" size="33" maxlength="20"/></td>
                  </tr>
                  <tr>
                    <td height="34" align="right">联系电话：</td>
                    <td height="34">&nbsp;<input name="mvo.phone" id="phone"  type="text" size="33" maxlength="20"/></td>
                  </tr>
                  <tr>
                    <td height="34" align="right">送车地址：</td>
                    <td height="34">&nbsp;<input name="mvo.addr" id="addr"  type="text" size="33" maxlength="20"/>
                    <input name="mvo.goods.gid" id="phone"  type="hidden" value="${gid}" size="33" maxlength="20"/>
                    </td>
                  </tr>
