      ...
      <tr>
		...
		<c:forEach items="${pi.list}" var="obj" varStatus="con">
			    ...
			    <table width="600" border="0" align="center">
                  <tr>
                    <td width="174" rowspan="6"><a href="<%=request.getContextPath() %>/goods_info?mvo.gid=${obj.gid }"><img  src="<%=request.getContextPath() %>/${obj.picurl}"  width="158" height="130" class="img" /></a></td>
                    <td width="416">名称：${obj.name }
					&nbsp;&nbsp;<a href="<%=request.getContextPath() %>/cartadd_admin?mvo.goods.gid=${obj.gid }">预订</a></td>
                  </tr>
                  <tr>
